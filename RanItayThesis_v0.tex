...
\usepackage[colorlinks=true,
		     allcolors=blue,
		     linktoc=all]{hyperref}              %Creates hyperlinks in cross references
\hypersetup{linktocpage}

\usepackage{memhfixc}					%Must be used on memoir document 
\usepackage{pdfpages}% Include figure files
...
\newcommand{\Th}{$^{228}\mathrm{Th}$}
\newcommand{\Cs}{$^{137}\mathrm{Cs}$}
\newcommand{\CoS}{$^{60}\mathrm{Co}$}
\newcommand{\CoF}{$^{57}\mathrm{Co}$}
\newcommand{\cdm}{$\Lambda$--CDM}
%\newcommand{\Th228}{$^{228}\mathrm{Th}$}
...
\pagenumbering{roman}
%
\includepdf[pages=1]{phd_thesis_title_page.pdf}
...
\import{chapters/EFT/}{EFT.tex}
\import{chapters/Direxeno/}{Direxeno.tex}
\import{chapters/Calibration/}{Calibration.tex}
\clearemptydoublepage
