...
\mycaption[The \textsc{DireXeno} system]{The \textsc{DireXeno} system mounted on the three racks. 1. The gas handling system. 2. The cryogenic system including the heat exchanger. 3. The detector chamber. 4. The Data acquisition system.
\label{fig:fulldet}}
\end{figure}
...
\mycaption[\textsc{DireXeno} gas schematics]{Schematics of the gas handling system. High pressure valves are indicated as 
...
\end{minipage}	
 \mycaption[Some relevant characteristics of HPFS-8655.]{Some relevant characteristics of HPFS-8655. (a) The refractive index as provided by corning and 
   extrapolated to relevant wavelength range. (b) The internal transmittance ($T_{i}$), measured in the lab using a monochromator.
...
\mycaption[Simulation of Number of events for discovery ]{The number of events needed for an emission pattern to achieve $5\sigma$ presented only for pattern 1 and 9, for different values of $r_{aniso}$.}
...
The setup of \textsc{DireXeno}, an experiment to measure the spatial and temporal distribution of LXe scintillation, has 
