...
\begin{figure}[]
	...
	\mycaption[Muon reduction id underground facilities]{ DThe muon reduction in different underground facilities hosting DM direct detection experiments.}
	\label{fig:MuonRed}
\end{figure}
...
\section{Liquid Nobel Detectors}
\label{sec:liquidDet}
